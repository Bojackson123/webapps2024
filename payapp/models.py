...
class Transaction(models.Model):
    ...
    sender_currency_sign = models.CharField(max_length=3, choices=CURRENCY_CHOICES, default="USD")
    receiver_currency_sign = models.CharField(max_length=3, choices=CURRENCY_CHOICES, default="USD")
